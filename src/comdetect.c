...
int main (int argc, char *argv[]){
  ...
  //setting this parameter greater than 1 will save the ID array out to file storedIDAry.txt and free the id array in order to save look up time - NOTE: translation will need to be done later if this is used
  int storeIDAry = 1;
